...
#================================================== TRAIN ==================================================
!onmt_train -data '$SAVEFILE/squad_id_split0.9_cased' -save_model '$CHKP/onmt/gru_033' \
...
#================================================== TRANSLATE ==================================================
#-------------------------------------------------- SQUAD --------------------------------------------------
!onmt_translate -model '$CHKP/onmt/gru_033_step_32100.pt' \
    -src '$TESTFILE/squad_id_split0.9_cased_source.txt' -output '$MODEL/reports/txts/onmt/gru_033_step_32100_pred.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
#-------------------------------------------------- TYDIQA --------------------------------------------------
!onmt_translate -model '$CHKP/onmt/gru_033_step_32100.pt' \
    -src '$TESTFILE/tydiqa_id_split0.9_cased_source.txt' -output '$MODEL/reports/txts/onmt/gru_033_step_32100_pred_tydiqa.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
!python '$SRCFILE/run_evaluation.py' \
    ...
    --prediction_file='$MODEL/reports/txts/onmt/gru_033_step_32100_pred.txt' \
    --log_file='$MODEL/reports/txts/onmt/eval_log_gru_033_step_32100.txt'

#-------------------------------------------------- TYDIQA --------------------------------------------------
!python '$SRCFILE/run_evaluation.py' \
    --source_file='$TESTFILE/tydiqa_id_split0.9_cased_source.txt' \
    --target_file='$TESTFILE/tydiqa_id_split0.9_cased_target.txt' \
    --prediction_file='$MODEL/reports/txts/onmt/gru_033_step_32100_pred_tydiqa.txt' \
    --log_file='$MODEL/reports/txts/onmt/eval_log_gru_033_step_32100_tydiqa.txt'
