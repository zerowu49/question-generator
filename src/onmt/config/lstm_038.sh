...
#================================================== TRAIN ==================================================
!onmt_train -data '$SAVEFILE/squad_id_split0.9_uncased' -save_model '$CHKP/onmt/lstm_038' \
...
#================================================== TRANSLATE ==================================================
#-------------------------------------------------- SQUAD --------------------------------------------------
!onmt_translate -model '$CHKP/onmt/lstm_038_step_16050.pt' \
    -src '$TESTFILE/squad_id_split0.9_uncased_source.txt' -output '$MODEL/reports/txts/onmt/lstm_038_step_16050_pred.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
#-------------------------------------------------- TYDIQA --------------------------------------------------
!onmt_translate -model '$CHKP/onmt/lstm_038_step_16050.pt' \
    -src '$TESTFILE/tydiqa_id_split0.9_uncased_source.txt' -output '$MODEL/reports/txts/onmt/lstm_038_step_16050_pred_tydiqa.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
!python '$SRCFILE/run_evaluation.py' \
    ...
    --prediction_file='$MODEL/reports/txts/onmt/lstm_038_step_16050_pred.txt' \
    --log_file='$MODEL/reports/txts/onmt/eval_log_lstm_038_step_16050.txt'

#-------------------------------------------------- TYDIQA --------------------------------------------------
!python '$SRCFILE/run_evaluation.py' \
    --source_file='$TESTFILE/tydiqa_id_split0.9_uncased_source.txt' \
    --target_file='$TESTFILE/tydiqa_id_split0.9_uncased_target.txt' \
    --prediction_file='$MODEL/reports/txts/onmt/lstm_038_step_16050_pred_tydiqa.txt' \
    --log_file='$MODEL/reports/txts/onmt/eval_log_lstm_038_step_16050_tydiqa.txt'
